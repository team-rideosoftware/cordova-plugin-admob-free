...
test('setOptions() call correct native method', () => {
  ...
  expect(mockFn).toHaveBeenCalledWith(success, error, 'AdMob', 'setOptions', [
    options,
  ])
})
...
describe('Old APIs', () => {
  ...
  it('showAd() should work', () => {
    ...
    expect(mockFn).toHaveBeenCalledWith(success, error, 'AdMob', 'showAd', [false])
    admob.showAd(true, success, error)
    expect(mockFn).toHaveBeenCalledWith(success, error, 'AdMob', 'showAd', [true])
  })
  ...
  it('showInterstitialAd() should work', () => {
    ...
    expect(
      mockFn,
    ).toHaveBeenCalledWith(success, error, 'AdMob', 'showInterstitialAd', [false])
    admob.showInterstitialAd(true, success, error)
    expect(
      mockFn,
    ).toHaveBeenCalledWith(success, error, 'AdMob', 'showInterstitialAd', [true])
  })
})
